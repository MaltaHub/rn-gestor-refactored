...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      notificacoes: {
        Row: {
          ...
          destinatario_papel:
            | Database["public"]["Enums"]["papel_usuario_empresa"][]
            | null
      ...
      notificacoes_leituras: {
        ...
        Relationships: [
          {
            foreignKeyName: "notificacoes_leituras_notificacao_fkey"
    ...
    Enums: {
      app_role: "admin" | "gerente" | "usuario" | "proprietario"
      estado_veiculo:
        | "novo"
        | "seminovo"
        | "usado"
      ...
      status_venda:
        ...
        | "cancelada"
        | "devolvida"
      tipo_cambio: "manual" | "automatico" | "cvt" | "outro" | "automatizado"
      tipo_carroceria:
        | "sedan"
        | "hatch"
        | "camioneta"
